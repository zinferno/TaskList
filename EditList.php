...
?>
<form id='Edit' action='index.php' method='post' align='left'><button type='submit'>Main Menu</button><br/><br/></form>
<form id="user-data-form" role="form" action='EditList.php' method="post" class="form-horizontal" align="center" autocomplete="off">
		<input type="hidden" id="Task_Id" name="Task_Id" <?php if(isset($_POST['Task_Id'])){ echo "value='" . $_POST['Task_Id'] . "'"; }?> />
        
        <fieldset class="user-fieldset">

            <div class="user-form">
                <label class="form-title" style="color: #F8741B; font-size: 22px;font-weight: bold; text-decoration:none">Edit Task</label>
            </div>
            <br/>
...
?>
            ...
            <button type="submit" class="btn btn-primary ynt-btn-orange">Edit</button>
